...
# -----------------------------------------------------------------------------
# Use the current directory for saving data and files
CURRENT_DIR = os.path.dirname(__file__)

def download():
    """Downloads the TinyStories dataset to the current directory"""
    # download the TinyStories dataset, unless it's already downloaded
    data_url = "https://huggingface.co/datasets/roneneldan/TinyStories/resolve/main/TinyStories_all_data.tar.gz"
    data_filename = os.path.join(CURRENT_DIR, "TinyStories_all_data.tar.gz")
    ...
    data_dir = os.path.join(CURRENT_DIR, "TinyStories_all_data")
...
def tokenize():
    ...
    for split_name, split_shards in [("val", val_shards), ("train", train_shards)]:
        ...
        split_filename = os.path.join(CURRENT_DIR, f"{split_name}.bin")
